        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="p-3 rounded-full bg-surface hover:bg-surface-elevated border hover:bg-red-500
            ...
            <a
              ...
              className="p-3 rounded-full bg-surface hover:bg-surface-elevated hover:bg-green-400 hover:text-white border border-border hover:border-primary/50 transition-all"
            >
              <Phone className="w-5 h-5 text-muted-foreground hover:text-primary  transition-colors" />
            </a>
            <a
              href="mailto:articopro.team@gmail.com"
              className="p-3 rounded-full bg-surface hover:bg-yellow-500
               hover:bg-surface-elevated border border-border hover:border-primary/50 transition-all"
            >
